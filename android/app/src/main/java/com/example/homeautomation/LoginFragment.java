                    ...
                    if (task.isSuccessful()) {
                        userDatabase.child(mAuth.getCurrentUser().getUid()).addListenerForSingleValueEvent(new ValueEventListener() {
                            ...
                            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                                ...
                                Boolean isVerifiedByAdmin = dataSnapshot.child("verifiedByAdmin").getValue(Boolean.class);
                                isVerifiedByAdmin = isVerifiedByAdmin==null ? false:isVerifiedByAdmin;
                                String role = dataSnapshot.child("role").getValue(String.class);
                                role = role == null ? "member" : role;

                                mDialog.dismiss();
                                if(role.equalsIgnoreCase("admin") || isVerifiedByAdmin) {
                                    ...
                                    Toast.makeText(getContext(), "Your verification by admin is pending", Toast.LENGTH_LONG).show();
                                    mAuth.signOut();
                                }
                            }
